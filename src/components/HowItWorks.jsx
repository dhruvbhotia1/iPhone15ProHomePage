...
import {frameImg} from "../utils/index.js";

import {frameVideo} from "../utils/index.js";
                ...
                <div className='mt-10 md:mt-20 mb-14 '>
                    <div className='relative h-full flex-center'>
                        ...
                        <div className='hiw-video'>
                            <video className='pointer-events-none' playsInline preload='none' muted autoPlay={true} ref={videoRef}>
