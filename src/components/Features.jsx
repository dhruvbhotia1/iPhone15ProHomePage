...
import {explore1Img} from "../utils/index.js";
import {explore2Img} from "../utils/index.js";
                    ...
                    <div className='flex-center flex-col sm:px-10'>
                        ...
                        <div className='flex flex-col w-full relative'>
                            ...
                            <div className='feature-text-container'>
                                ...
                                <div className='flex-1 flex-center'>
                                    <p className='feature-text g_text'>Titanium has of the best strength-to-weight ratios of any metal, making these our{' '}
